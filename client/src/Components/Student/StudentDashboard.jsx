  ...
  const services = [
    {
      ...
      icon: "👤",
      action: () => navigate("/showAllStudentInfo", { state: { ID } }),
      color: "student",
    },
    {
      title: "Room Change",
    ...
    },
    {
      ...
      icon: "📅",
      action: () => navigate("/leaveRequest", { state: { ID } }),
      color: "student",
    },
    {
      title: "Complaints",
      ...
      icon: "📝",
      action: () => navigate("/complaint", { state: { ID } }),
      color: "warden",
    },
    {
    ...
    },
    {
      ...
      icon: "🚪",
      action: () => navigate("/guestEntry", { state: { ID } }),
      color: "warden",
    },
  ];
